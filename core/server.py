...
from core.apis.assignments import student_assignments_resources, teacher_assignment_submitted_resources
...
app.register_blueprint(
    teacher_assignment_submitted_resources, url_prefix='/teacher')
